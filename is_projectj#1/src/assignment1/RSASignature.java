...
public class RSASignature {
  public static void main(String[] args) throws Exception {
    ...
    kpg.initialize(1024,random); //1024bit, random
    KeyPair keyPair = kpg.genKeyPair();
    PublicKey publicKey = keyPair.getPublic(); //get publickey
    PrivateKey privateKey = keyPair.getPrivate(); //get privatekey
    byte[] pubk = publicKey.getEncoded(); //encoding pubk
    byte[] prik = privateKey.getEncoded(); //encoding privkey
